...
@Component({
      ...
      <mat-card class="auth-card">
        ...
        <form [formGroup]="form" (ngSubmit)="onSubmit()" autocomplete="off">
          <mat-form-field appearance="outline" class="full-width">
            ...
            <input matInput type="text" formControlName="name" placeholder="Enter your name" autocomplete="new-name">
          ...
          <mat-form-field appearance="outline" class="full-width">
            ...
            <input matInput type="email" formControlName="email" placeholder="Enter your email" autocomplete="new-email">
          ...
          <mat-form-field appearance="outline" class="full-width">
            ...
            <input matInput [type]="hidePassword ? 'password' : 'text'" formControlName="password" placeholder="Min 6 characters" autocomplete="new-password">
          ...
          <button mat-raised-button color="primary" class="signup-btn" type="submit" [disabled]="form.invalid || isLoading()">
            @if (isLoading()) {
  ...
  styles: [`
    ...
    .auth-card { width: 100%; max-width: 440px; padding: 3rem 2.5rem; }
    ...
    .signup-btn { width: 100%; padding: 0.6rem; font-size: 1rem; margin-top: 0.5rem; transition: all 0.2s ease; }
    .signup-btn:hover:not([disabled]) { filter: brightness(1.3); transform: translateY(-1px); box-shadow: 0 4px 15px rgba(14, 165, 233, 0.4); }
    .auth-link {
